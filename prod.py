...
class Player:
    ...
    def income(self):
        print("~Income~")
        self.numCoins += 1
        playerNumber = self.getPlayerNumber()
        print("Player " + str(playerNumber) + " coins: " + str(self.numCoins))
        print()
    ...
    def flipCard(self):
        print()
        victimNumber = self.getPlayerNumber()
        if self.card1.name == "Flipped":
    ...
    def getAllInfo(self):
        return self.name, self.playerNumber, self.numCoins, self.card1, self.card2
...
def initializePlayers():
    for i in range(1, numPlayers + 1):
        name = input("Player " + str(i) + ", enter your name: ")
...
def printAllPlayerInfo():
    ...
    for key in keys:
        ...
        name, playerNumber, numCoins, card1, card2 = player.getAllInfo()
        print("Player name: " + name + ", Player number: " + str(playerNumber) + ", Number of coins: " + str(numCoins) + ", Card 1: " + card1.name + ", Card 2: " + card2.name)
...
def showPlayerCards():
    ...
    for key in keys:
        player = players.get(key)
        ready = input(player.name + ", enter any key when ready to see your cards: ")
        print(player.name + ", Card 1: " + str(player.card1.name) + ", Card 2: " + str(player.card2.name))
        done = input(player.name + ", enter any key when you wish to clear the screen: ")
        os.system('cls||clear')
...
def makeMove(player):
    ...
    print("Enter 0 for move list, enter 1-7 for your move, enter 8 to see your cards, or enter 9 for game update")
    ...
    # CHECK CARDS & FLIPPED CARDS
    elif (move == 8):
        print("~CARD CHECK~")
        ready = input(player.name + ", enter any key when ready to see your cards: ")
        print("Your cards:")
        print("Card 1: " + str(player.card1.name) + ", Card 2: " + str(player.card2.name))
        print()
        print("Flipped cards: ")
    ...
    # GAME UPDATE
        ...
        for key in keys:
            print("Player " + str(players[key].playerNumber) + "-> name: " + players[key].name + ", coins: " + str(players[key].numCoins) + ", cards: " + str(str(players[key].numCards)))
        print()
        return False
    else:
...
def getPlayerByNum(playerNumber):
